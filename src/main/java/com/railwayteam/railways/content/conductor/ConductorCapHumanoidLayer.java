...
public class ConductorCapHumanoidLayer<T extends LivingEntity, M extends HumanoidModel<T>> extends RenderLayer<T, M> {
	public ConductorCapHumanoidLayer(RenderLayerParent<T, M> renderer) {
		super(renderer);
	}
	...
	public void render(@NotNull PoseStack poseStack, @NotNull MultiBufferSource buffer, int packedLight,
		...
		ConductorCapModel<?> model = ConductorCapModel.of(headItem, this.getParentModel(), entity);
